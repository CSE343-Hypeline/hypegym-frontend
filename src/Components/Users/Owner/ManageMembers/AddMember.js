...
function AddMember({ gym_id, setIsSubmit }) {
  ...
  const formik = useFormik({
    ...
    validate: (data) => {
      ...
      if (!data.gender) errors.gender = "You need to choose gender.";
          ...
          >
            <div className="flex align-items-center flex-column pt-6 px-3">
              ...
              <p style={{ lineHeight: 1.5, textIndent: "1rem" }}>
                Your new member is registered. It'll be valid in 2 minutes
                without activation.
              </p>
            </div>
          </Dialog>
                ...
                <div className="field">
                  <span className="p-float-label">
                    <Calendar
                      ...
                      showIcon
                    />
                    <label htmlFor="date">Membership Start Date</label>
                  </span>
